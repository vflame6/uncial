...
@Suite struct SettingsTextTests {
    @Test func attachmentsFooterDescribesTheSearch() {
        ...
        #expect(everywhere == "A missing image or linked file is looked for in the “attachments” folder next to the document, then in the folders above it and their “attachments” folders, up to your home folder. Pasted or dropped files and pictures go to the “attachments” folder next to the document, created as needed, and are inserted as links or images.")
        ...
        #expect(toRoot.hasSuffix("Pasted or dropped files and pictures go to the first “assets” folder found above the document, or to one created next to it, and are inserted as links or images."))
        ...
        #expect(nextToTheDocument == "A missing image or linked file is looked for in the “attachments” folder next to the document. Pasted or dropped files and pictures go to the “attachments” folder next to the document, created as needed, and are inserted as links or images.")
        ...
        #expect(foldersOnly == "A missing image or linked file is looked for in the folders above the document, up to your home folder. Pasted or dropped files and pictures go next to the document and are inserted as links or images.")

        let nowhere = GeneralSettingsView.attachmentsFooter(for: .direct, destination: .documentFolder)
        #expect(nowhere == "A missing image or linked file is not looked for elsewhere. Pasted or dropped files and pictures go next to the document and are inserted as links or images.")

        let documentFolder = GeneralSettingsView.attachmentsFooter(for: AttachmentSearch(), destination: .documentFolder)
        #expect(documentFolder.hasSuffix("Pasted or dropped files and pictures go next to the document and are inserted as links or images."))
    }
